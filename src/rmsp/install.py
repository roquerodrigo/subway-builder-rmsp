...
def install() -> None:
    ...
    # The game resolves a city's data from the by-code cities/data/<CODE> dir.
    dest = settings.city_data
    ...
    log.info("enable the mod (dev.rodrigoroque.rmsp) in Settings > Mods and restart the game")
